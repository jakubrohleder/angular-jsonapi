...
describe('$$AngularJsonAPIAbstractDataFactory service', function(){
  var schema = {
    'type': 'novels',
    'id': 'uuid4',
    'title': 'string',
  ...
  beforeEach(inject(function(_$$AngularJsonAPIAbstractDataFactory_) {
    Novels = _$$AngularJsonAPIAbstractDataFactory_.model(schema, linkGetters);
    novel = new Novels(data);
  }));

  it('is ok', inject(function($$AngularJsonAPIAbstractDataFactory){
    expect($$AngularJsonAPIAbstractDataFactory).to.be.ok;
    expect(Novels).to.be.ok;
