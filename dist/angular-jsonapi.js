...
(function() {
  ...
  AngularJsonAPIAbstractDataWrapper.$inject = ["$log", "uuid4", "lazyProperty", "AngularJsonAPIAbstractDataForm", "$timeout"];
})();
...
(function() {
  ...
  AngularJsonAPIFactoryWrapper.$inject = ["$log", "uuid4", "JsonAPIModelFactory", "AngularJsonAPISchema"];
})();
